...
R = [i for i in range(1,17)] #regiones
C1 = [(i,j)for i in K for j in K] #celdas


#parametros 
#OPERACIONES
O={1:"SUMA",2:"SUMA",3:"SUMA",4:"SUMA",5:"SUMA",6:"SUMA",7:"SUMA",8:"SUMA",
   9:"SUMA",10:"SUMA",11:"SUMA",12:"SUMA",13:"SUMA",14:"SUMA",15:"SUMA",16:"SUMA"}
#RESULTADOS_ESPERADOS
E={1:7,2:9,3:9,4:6,5:5,6:10,7:4,8:6,9:7,10:8,11:10,12:5,13:10,14:3,15:11,16:16}

#CELDAS POR REGION
C={1:[(1,1),(1,2)], 2:[(2,1),(3,1)], 3:[(4,1),(5,1)], 4:[(6,1),(6,2),(5,2)],5:[(4,2),(3,2)],
   6:[(2,2),(2,3)],7:[(1,3),(1,4)],8:[(3,3),(3,4)],9:[(5,3),(4,3)],10:[(6,3),(6,4)],
   11:[(4,4),(5,4)],12:[(2,5),(2,4)],13:[(1,6),(1,5)],14:[(2,6),(3,6)],15:[(3,5),(4,5),(4,6)],
   16:[(5,5),(5,6),(6,6),(6,5)]}
